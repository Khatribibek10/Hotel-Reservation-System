                        ...
                        <div class="col-lg-12 login-form">
                            <form action="LoginServlet" method="post">
                                ...
                                <div class="col-lg-6 alternative mb-4 ">
                                    <a href="Signup.jsp" style="color:white; font-weight: bold;text-decoration:none">Don't have an account?</a>
                                </div>

                                <div class="col-lg-6 alternative mb-4 ">
                                    <a href="admin_login.jsp" style="color:white; font-weight: bold;text-decoration:none">Login as admin?</a>
                                </div>
                            </form>
                        </div>
                    </div>                    
