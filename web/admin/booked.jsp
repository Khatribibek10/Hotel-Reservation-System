                ...
                <table class="table table-striped" border='1'>
                    ...
                    <tbody>
                        <%   
                            ...
                            String query = "select * from reservation join users on reservation.user_id = users.id join rooms on reservation.room_id=rooms.id where reservation.status=1";
                        ...
                        <tr>
                            ...
                            <td><%= room_number%></td>
                            <td>Rs.<%= price%></td>
                            <td><a href="checkoutbutton.jsp?id=<%= id%>"><button type="submit" class="btn btn-danger">Check Out</button></a></td>
                        </tr>

                        <%}%>
                        
                        <%
                            String sql1 = "select count(*) from reservation where reservation.status = 1";
                        ...
                        <tr>
                            <th colspan="5">
                                <table width="100%">
                                    ...
                                    <a href="booked.jsp?pgno=<%= i%>" class="btn btn-info active" > Page<%= i + 1%></a>
                                    <% }%>
                                     </tr>
                                </table>
                            </th>
